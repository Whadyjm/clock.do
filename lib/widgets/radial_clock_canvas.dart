                  ...
                  if (block.priority.hasPriority) ...[
                    ...
                    Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(block.priority.icon, size: 9, color: block.priority.color),
                  ...
                  if (block.isRecurring) ...[
                    ...
                    Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          const Icon(Icons.repeat_rounded, size: 9, color: Color(0xFF00CEC9)),
                          const SizedBox(width: 2.5),
                          Text(
                  ...
                  if (block.hasIntervalReminder) ...[
                    ...
                    Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          const Icon(Icons.timer_outlined, size: 9, color: Color(0xFF6C5CE7)),
                          const SizedBox(width: 2.5),
                          Text(
